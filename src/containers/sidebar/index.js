    ...
    <MuiThemeProvider>
        <div>
            <List>  
                ...
                <Divider />
                <ListItem>
                     <Chip className="person"><Avatar src={Avi} size={50} /><p class="name"> Lloyd Jimenez</p></Chip>
                ...
                <Divider />
                <ListItem>
                     <Chip className="person"><Avatar src={Avi} size={50} /><p class="name"> Terry Gordon</p></Chip>
